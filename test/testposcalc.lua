...
function TestMovingArea:__doInitDanmakuArea(a, start, speed, width)
    a.start = start
    a.speed = speed
    a.width = width
end
...
function TestMovingArea:testDuration()
...
function TestIntersectedHeight:testMain()
...
function TestPosCalculator:__doInitAreaHeights(calc, heights)
...
function TestPosCalculator:__sumHeights(heights)
    local sum = 0
...
function TestPosCalculator:testAddArea()
...
function TestPosCalculator:testScoreSum()
...
function TestPosCalculator:testTopToBottomPos()
...
function TestPosCalculator:testLeftToRightPos()
