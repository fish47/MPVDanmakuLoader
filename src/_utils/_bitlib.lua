...
local _META_VALUES_BANDWIDTH_POW            = math.floor(2 ^ _META_VALUES_BIT_COUNT)
local _META_CACHED_VALUES_AND          =
{
    [0 * _META_VALUES_BANDWIDTH_POW + 0]    = 0,    -- 0 and 0 = 0
    [0 * _META_VALUES_BANDWIDTH_POW + 1]    = 0,    -- 0 and 1 = 0
    [1 * _META_VALUES_BANDWIDTH_POW + 0]    = 0,    -- 1 and 1 = 0
    [1 * _META_VALUES_BANDWIDTH_POW + 1]    = 1,    -- 1 and 1 = 1
}

local _META_CACHED_VALUES_OR           =
{
    [0 * _META_VALUES_BANDWIDTH_POW + 0]    = 0,    -- 0 or 0 = 0
    [0 * _META_VALUES_BANDWIDTH_POW + 1]    = 1,    -- 0 or 1 = 1
    [1 * _META_VALUES_BANDWIDTH_POW + 0]    = 1,    -- 0 or 1 = 1
    [1 * _META_VALUES_BANDWIDTH_POW + 1]    = 1,    -- 0 or 1 = 1
}

local _META_CACHED_VALUES_XOR          =
{
    [0 * _META_VALUES_BANDWIDTH_POW + 0]    = 0,    -- 0 xor 0 = 0
    [0 * _META_VALUES_BANDWIDTH_POW + 1]    = 1,    -- 0 xor 1 = 1
    [1 * _META_VALUES_BANDWIDTH_POW + 0]    = 1,    -- 1 xor 0 = 1
    [1 * _META_VALUES_BANDWIDTH_POW + 1]    = 0,    -- 1 xor 1 = 0
}
...
{
    [0 * _META_VALUES_BANDWIDTH_POW + 0]    = 0,    -- ignored
    [0 * _META_VALUES_BANDWIDTH_POW + 1]    = 1,    -- not 0 = 1
    [1 * _META_VALUES_BANDWIDTH_POW + 0]    = 1,    -- not 1 = 0
    [1 * _META_VALUES_BANDWIDTH_POW + 1]    = 0,    -- ignored
}
...
local _CACHED_VALUES_BANDWIDTH_POW  = math.floor(2 ^ _CACHED_VALUES_BIT_COUNT)
